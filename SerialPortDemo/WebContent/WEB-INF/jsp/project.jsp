    ...
    <div  id="body" region="center"  hide="true"  split="true" title="实时监控" style="background: white; height: 335px;">
       	...
       	<form id="fm" method="post" data-options="novalidate:true" style="margin:0;padding:20px 50px;">
            <div style="margin-bottom:10px;" align="left">
               <label style="display:inline-block">xxx项目</label> 
            </div>
            <div style="margin-bottom:10px" align="left">
        ...
        <form id="fm" method="post" data-options="novalidate:true" style="margin:0;padding:20px 50px;">
            <div style="margin-bottom:10px;" align="left">
               <div style=" width:17px; height:17px; background-color:#0000CD; border-radius:25px; float:left;"></div><label style="display:inline-block">焊机编号</label> 
            </div>
            <div style="margin-bottom:10px" align="left">
               <label for="status" style="text-align:center;display:inline-block;">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;压</label> <input name="status" id="status" class="easyui-textbox">
            </div>
            <div style="margin-bottom:10px;">
              <label for="on" style="text-align:center;display:inline-block">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;流</label> <input name="on" id="on" class="easyui-textbox">
            </div>
            <div style="margin-bottom:10px">
              <label for="warning" style="text-align:center;display:inline-block">焊工编号</label> <input name="warning" id="warning" class="easyui-textbox">
            </div>
            <div style="margin-bottom:10px">
              <label for="wait" style="text-align:center;display:inline-block">焊工姓名</label> <input name="wait" id="wait" class="easyui-textbox">
            </div>
            <div style="margin-bottom:10px">
               <label for="off" style="text-align:center;display:inline-block">设备位置</label> <input name="off" id="off" class="easyui-textbox">
            </div>
        </form>
        </div>
</body>
